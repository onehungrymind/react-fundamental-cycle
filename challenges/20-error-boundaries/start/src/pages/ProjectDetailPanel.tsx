...
//
// TODO: Wrap <ProjectDetailContent> below in an ErrorBoundary.
//
// If something in the project detail content throws (e.g. a bad
// date format passed to new Date() causes a crash), only this panel
// should show the fallback — the project list sidebar should still work.
//
// Placement hint — inside ProjectDetailPanel, before the final return:
//   return (
...
export function ProjectDetailPanel() {
  ...
  // TODO: Wrap ProjectDetailContent in an ErrorBoundary here
