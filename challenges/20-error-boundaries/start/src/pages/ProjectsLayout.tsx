...
//
// TODO: Wrap the project list <aside> below in an ErrorBoundary.
//
// If the project list throws during render (e.g. a bad data shape
// causes a crash in ProjectListItem), only the sidebar should show
// the fallback — the detail panel on the right should still work.
//
// Placement hint:
...
export function ProjectsLayout() {
  ...
  return (
    <div className="projects-layout">
      {/* TODO: Wrap this <aside> in an ErrorBoundary */}
