...
//
// The project list <aside> is wrapped in an ErrorBoundary.
//
// Isolation effect: if any component inside the sidebar throws during
// render (e.g. ProjectListItem crashes on an unexpected data shape),
// the fallback replaces only the sidebar.  The detail panel on the right
// remains fully functional.
//
// The boundary uses the default fallback (DefaultErrorFallback) which
// provides a "Try Again" button that calls resetError(), re-mounting
// the sidebar tree and retrying the render.
...
export function ProjectsLayout() {
  ...
  return (
    <div className="projects-layout">
      {/*
        ErrorBoundary wraps the entire sidebar.
        If anything inside (filters, sort buttons, ProjectListItem rows)
        throws during render, the fallback appears in place of the sidebar.
        The <section> (detail panel) on the right is unaffected.
      */}
      <ErrorBoundary>
