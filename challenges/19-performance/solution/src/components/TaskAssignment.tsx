...
//
// TaskAssignment now receives `onAssign` as a prop.
// The mutation is owned by the parent (TaskList) and stabilised
// with useCallback so that React.memo on TaskItem is effective.
