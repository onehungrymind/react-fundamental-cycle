...
// ProjectsLayout reads filter state from the Redux store.
// Because the store lives outside component lifecycle, filter
// choices survive navigation just like they did with Zustand.

export function ProjectsLayout() {
  const { data: projects = [], isPending, error, refetch } = useProjects()
  const queryClient = useQueryClient()

  // Filter + sort state from the Redux store — persists across navigation
