...
// Layout reads sidebar collapsed state from the Redux store.
// The toggle action is dispatched when the Header button is clicked.
//
// useAppSelector subscribes to a slice of state — the component
// re-renders only when state.sidebar.isCollapsed changes.
