...
// This hook manages filter state locally.
// Challenge 17: Replace this with useFilterPreferences() from the Zustand store
// so that filter selections persist when navigating away and back.
