...
// ProjectsLayout reads filter state from the Zustand store via
// useFilterPreferences().  Because the store is a module-level singleton
// (not tied to component lifecycle), filter choices survive navigation:
// clicking into a project and pressing Back restores the previous filter.
