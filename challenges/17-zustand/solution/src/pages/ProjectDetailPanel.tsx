...
// ProjectDetailPanel calls addRecentlyViewed(projectId) from the Zustand
...
export function ProjectDetailPanel() {
  ...
  // Read action directly from the store (no selector needed for single actions)
  ...
  }, [projectId, project, addRecentlyViewed])
