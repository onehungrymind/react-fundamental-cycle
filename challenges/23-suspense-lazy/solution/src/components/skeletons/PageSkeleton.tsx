// Generic page-level skeleton fallback.
//
// Used as a catch-all Suspense fallback for any full-page lazy component
// that does not have a more specific skeleton.
//
// Renders a generic page layout shape:
//   - Page header (title bar + action button placeholder)
//   - Three content blocks of decreasing width
//   - A grid of card placeholders
//
// All skeleton elements use the `.skeleton` CSS class with the shimmer
// animation defined in App.css.
