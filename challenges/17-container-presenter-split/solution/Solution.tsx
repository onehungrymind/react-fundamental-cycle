...
export default function Solution(){ const [sel,setSel]=React.useState<number|undefined>(); const items=[{id:1,t:'A'},{id:2,t:'B'}]; const item=items.find(i=>i.id===sel); return <div><ListP items={items} sel={sel} onSelect={setSel}/><DetailP item={item}/></div>; }
