...
//
// This is the START version.  The app runs correctly but has several
// accessibility issues:
//
//   1. Modal.tsx — no focus trap, no Escape key, no ARIA dialog attributes
//   2. Sidebar.tsx — nav lacks aria-label, NavLink lacks aria-current
//   3. TaskStatusButton.tsx — buttons lack descriptive aria-label
//   4. App.css — some badge color combinations fail WCAG AA contrast
//
// Run: npm run dev
// Test: npm test
