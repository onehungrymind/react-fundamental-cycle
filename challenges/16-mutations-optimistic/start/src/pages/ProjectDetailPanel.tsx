...
// The fetched tasks array is passed to child routes via Outlet context.
//
// After Challenge 16:
//   - Mutations update the cache via queryClient.setQueryData
//   - The Outlet context will automatically reflect those updates
//     because it reads from the query cache (via useProject)
