...
// TASKS is hardcoded seed data for the task list.
//
// Tasks are scoped to proj-1 (Website Redesign) and proj-2 (Mobile App MVP)
// so the master-detail task list has meaningful content to display.
//
// In a later challenge this will be replaced by API data fetched with
// useEffect or a data-loading library.
...
// Assignee display names keyed by assigneeId.
// Used by TaskItem and TaskDetail to show a human-readable name without
// importing a full team-members dataset.
