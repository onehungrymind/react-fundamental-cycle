...
//
// Keeping it in a separate module lets both ProjectListPage (which copies it
// into useState) and ProjectDetailPage (which searches it by ID) import the
// same source of truth without circular dependencies.
