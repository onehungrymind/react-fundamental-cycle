...
//
// Challenge 12 starting point: same routing as Challenge 11.
// Your tasks for this challenge:
//   1. Create ThemeProvider in src/context/ThemeContext.tsx
//   2. Create AuthProvider in src/context/AuthContext.tsx
//   3. Wrap this tree with <ThemeProvider> and <AuthProvider>
//   4. Update Header to use useTheme() and useAuth()
//   5. Update index.css to add [data-theme="dark"] CSS variable overrides
