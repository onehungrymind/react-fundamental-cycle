...
// TaskDetail reads from the static TASKS constant.
//
// This is intentional for Challenge 13: the task state managed by useReducer
// lives inside the TaskList component and is not accessible here because
// TaskDetail is rendered in a sibling route subtree (tasks/:taskId vs the
// index route that renders TaskList).
//
// To make the detail page reflect live reducer state you would need to either:
//   a) Lift useReducer state to a shared ancestor (e.g. ProjectDetailPanel), or
//   b) Put the reducer into a React Context (a natural follow-on challenge).
//
// For now, TaskDetail shows the static snapshot of the task.
